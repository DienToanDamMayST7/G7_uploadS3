...
public class UploadService {
	...
	public AmazonS3 getAmazonS3()
	{
		...
		AWSCredentials credentials = new BasicAWSCredentials(
				"AKIAJKYVUEMJLBEVYOAQ", //Access key ID
				"PnyNIj5XMQ8l2ODc87Ekd+KSJ+L7I2cm8eh4ScLJ"); //Secret access key
	...
	private static void createFolder(String bucketName, String folderName, AmazonS3 client) {
		//Tạo meta-data cho folder và đặt chiều dài nội dung là 0
		ObjectMetadata metadata = new ObjectMetadata();
		metadata.setContentLength(0);
		// Tạo nội dung trống
		InputStream emptyContent = new ByteArrayInputStream(new byte[0]);
		// tạo 1 PutObjectRequest passing the folder name suffixed by /
		PutObjectRequest putObjectRequest = new PutObjectRequest(bucketName, folderName + "/", emptyContent, metadata);
		// gửi yêu cầu đến S3 để tạo folder
