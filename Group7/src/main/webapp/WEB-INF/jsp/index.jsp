	...
	<div class="container">
		<div role="navigation">
			<div class="navbar navbar-default">
				<a href="/" class="navbar-brand">NHÓM - 7</a>
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						<li><a href="add-post">ĐĂNG BÀI</a></li>
						<li><a href="all-post">TẤT CẢ BÀI ĐĂNG</a></li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div class="container text-center">
				...
				<form class="form-horizontal" method="POST" enctype="multipart/form-data" action="save-post">
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<input type="file" class="form-control" name="file" value="${post.url}"/>
						</div>
					</div>
					<div class="form-group">
